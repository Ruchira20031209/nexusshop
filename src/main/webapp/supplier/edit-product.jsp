        ...
        <form action="${pageContext.request.contextPath}/pm/edit-product" method="post" enctype="multipart/form-data">
            ...
            <div class="form-section">
                    ...
                    <div class="image-gallery">
                        <c:forEach var="image" items="${images}">
                            <div class="image-item">
                                <img src="${pageContext.request.contextPath}${image.imageUrl}" alt="Product Image">
                                <input type="checkbox" class="image-checkbox" name="deleteImage" value="${image.imageID}">
                                <span style="position: absolute; bottom: 5px; left: 5px; background: rgba(0,0,0,0.7); color: white; padding: 2px 5px; border-radius: 3px; font-size: 0.7rem;">Delete</span>
                            </div>
                        </c:forEach>
                    </div>
                </c:if>
                ...
                <div class="file-input-group">
                    ...
                    <input type="file" name="newImage3" accept="image/*">
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="specs-container">
                    <c:forEach var="spec" items="${specs}" varStatus="status">
                        <div class="spec-row">
                    ...
                    <!-- Additional empty rows for new specs -->
                    <div class="spec-row">
...
<script>
    ...
    document.getElementById('addSpecBtn').addEventListener('click', function() {
        ...
        newRow.innerHTML = `
            ...
            <button type="button" class="remove-spec-btn" style="background: var(--danger); color: white; border: none; border-radius: 4px; padding: 0.5rem; cursor: pointer;">
    ...
    function confirmDelete() {
        if (confirm('Are you sure you want to delete this product? This action cannot be undone.')) {
            window.location.href = '${pageContext.request.contextPath}/pm/delete-product?productID=${product.productID}';
        }
    }
